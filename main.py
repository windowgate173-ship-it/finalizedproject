...
try:
   ...
   print("Music not found(01.Bad Piggies Theme.mp3)")
...
bg_log = pygame.image.load("mygamemenu.png").convert()
...
def run_game():
    ...
    s.fill((30, 26, 115))
    pygame.draw.rect(s,(0, 200, 255), p)
    ...
    s.blit(f.render(f"Tap ENTER for main menu", True, (254, 254, 254)), (200, 250))
